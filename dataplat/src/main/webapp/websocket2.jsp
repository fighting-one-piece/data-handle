...
//             ws = new WebSocket('ws://192.168.0.198:8080/dataplat/webSocketServer?accessToken=abc123');
            /* (url.indexOf('sockjs') != -1) ?   
            //new SockJS(url, undefined, {protocols_whitelist: transports}) :  */  
			ws = new SockJS('http://192.168.0.198:8080/dataplat/webSocketServer/sockjs');  
                  
            ws.onopen = function () {  
            	ws.send("accessToken:abc123");  
                setConnected(true);  
	...
	<div>
		<div id="connect-container">
			<input id="radio1" type="radio" name="group1"
				onclick="updateUrl('/mspjapi');"> <label for="radio1">W3C
				WebSocket</label> <br> <input id="radio2" type="radio" name="group1"
				onclick="updateUrl('/spring-websocket-test/sockjs/echo');">

package org.cisiondata.modules.kafka.consumer;
...
public class SimpleConsumer extends Thread {
	...
	private ConsumerConnector createConsumerConnector() {
		...
		// zookeeper配置
//		properties.put("zookeeper.connect", "172.20.100.115:2181/kafka");
	...
	public static void main(String[] args) {
		new SimpleConsumer("elastic5-test").start();// 使用kafka集群中创建好的主题 test
	}

package org.platform.utils.judge;
...
public class IdCardUtils {
	...
	public static boolean isValidIdCard(String idcard) {
		...
		return idcard.length() == 15 ? validate15IdCard(idcard) : validate18IdCard(idcard);
	}
	...
	public static boolean validate15IdCard(String idcard) {
		if (idcard == null || idcard.length() != 15 || !isDigital(idcard)) {
			return false;
		}
		String provinceid = idcard.substring(0, 2);
		if (!checkProvinceid(provinceid)) {
	...
	public static String convertIdCardFrom15To18(String idcard) {
		if (idcard == null || idcard.length() != 15 || !isDigital(idcard)) return null;
		String provinceid = idcard.substring(0, 2);
		// 校验省份

 ...
 *
 */
public class QQQQQunDataHDFS2ESV1Job extends BaseHDFS2ESV1Job {
		...
		try {
			...
			for (int i = 0, len = files.size(); i < len; i++) {
				...
				if ((i % 20 == 0 || i == (len - 1)) && i != 0) {
					...
					String[] args1 = new String[] { "qq", "qqqundata", "cisiondata", "192.168.0.10,192.168.0.12", sb.toString(),
							args[1]+i };
					ToolRunner.run(new QQQQQunDataHDFS2ESV1Job(), args1);

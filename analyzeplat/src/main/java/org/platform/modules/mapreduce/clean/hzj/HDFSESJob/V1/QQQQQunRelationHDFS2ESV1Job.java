 ...
 *
 */
public class QQQQQunRelationHDFS2ESV1Job extends BaseHDFS2ESV1Job {
		...
		try {
			...
			for (int i = 0, len = files.size(); i < len; i++) {
				...
				if ((i % 5 == 0 || i == (len - 1)) && i != 0) {
					...
					String[] args1 = new String[] { "qq", "qqqunrelation", "cisiondata","192.168.0.10,192.168.0.12","5000", sb.toString(),
							args[1]+i };
					ToolRunner.run(new QQQQQunRelationHDFS2ESV1Job(), args1);

...
public class MergeFile {
	...
	// 输入/输出文件路径
	static String pathIn = "hdfs://192.168.0.10:9000/elasticsearch_original/financial/finance/back/";
	static String pathOut = "hdfs://192.168.0.10:9000/elasticsearch_original/financial/finance/merge/";
	...
	public static void main(String[] args) throws Exception {
		...
		// 创建job对象
		Job job = Job.getInstance(conf, "MergeFinancialFinanceJob");
		// 设置运行的类

package org.platform.modules.mapreduce.clean.skm.Merge;
 ...
 * @author lixin
 */
public class MergeFinancialBusinessJob {

	static FileSystem fs = null;
	static Configuration conf = new Configuration();
	static String regex = "^(correct)+.*$";
	// 输入/输出文件路径
	static String pathIn = "hdfs://192.168.0.10:9000//elasticsearch_clean_1/financial_new/business";
	static String pathOut = "hdfs://192.168.0.10:9000//elasticsearch_clean_1/financial/business";
	...
	public static void main(String[] args) throws Exception {
		...
		// 设置运行的类
		job.setJarByClass(MergeFinancialBusinessJob.class);
		// 设置mapper类

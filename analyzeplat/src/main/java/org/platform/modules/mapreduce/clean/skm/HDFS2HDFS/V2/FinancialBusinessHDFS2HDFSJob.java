package org.platform.modules.mapreduce.clean.skm.HDFS2HDFS.V2;
...
public class FinancialBusinessHDFS2HDFSJob extends BaseHDFS2HDFSJob{
	...
	public static void main(String[] args){
		...
		//"hdfs://192.168.0.10:9000/warehouse_original/financial/business/20161219/"
		args = new String[]{"hdfs://192.168.0.115:9000/skm",
				            "hdfs://192.168.0.115:9000/skm1"};
		String fss = args[0];
			...
			for (Path p : listPath) {
				if (!p.getName().equals("_SUCCESS")
					...
					if(line!=null){
						...
						String[] args1 = new String[] {line,
								p.toString(),
								args[1]+"/"+ p.getName()};
						System.out.println("执行文件--------------->>>>>>>>>>>>>"+p.getName());
						exitCode = ToolRunner.run(new FinancialBusinessHDFS2HDFSJob(), args1);
					}
				}
			}
...
class BusinessHDFS2HDFSMapper extends BaseHDFS2HDFSV2Mapper {

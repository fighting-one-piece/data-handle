 ...
 *
 */
public class OperatorTelecomHDFS2ESV2Job extends BaseHDFS2ESV2Job {
		...
		try {
			...
			for (int i = 0, len = files.size(); i < len; i++) {
				...
				if ((i % 5 == 0 || i == (len - 1)) && i != 0) {
					...
					String[] args1 = new String[] { "operator", "telecom", "cisiondata", "192.168.0.10,192.168.0.12",
							sb.toString() };
					System.out.println("i>>" + i);
					System.out.println("路径:>>" + sb.toString());
					ToolRunner.run(new OperatorTelecomHDFS2ESV2Job(), args1);

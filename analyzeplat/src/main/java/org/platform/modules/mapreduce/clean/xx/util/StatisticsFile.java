...
public class StatisticsFile {
	...
	//输入/输出文件路径
	static String paths = "hdfs://192.168.0.10:9000/warehouse_original/financial/logistics/20170228/"; 
	static	String pathOut ="hdfs://192.168.0.115:9000/user/xx/test/"+fileName;	
	static FileSystem fs = null;
	static Configuration conf = new Configuration();
	static String regex = "^(logistics)+.*$";
	//static String regex = "";

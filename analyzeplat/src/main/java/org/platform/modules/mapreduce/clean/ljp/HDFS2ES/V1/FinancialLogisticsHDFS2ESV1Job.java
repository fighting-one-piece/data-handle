 ...
 * 7.批量导入ES大小 7.输出HDFS路径
 * 
 * @author Administrator
 *
 */
public class FinancialLogisticsHDFS2ESV1Job extends BaseHDFS2ESV1Job {
		...
		try {
			...
			for (int i = 0, len = files.size(); i < len; i++) {
				...
				if ((i % 1 == 0 || i == (len - 1)) && i != 0) {
					...
					String[] args1 = new String[] {"financial", "logistics", "cisiondata", 
							"192.168.0.10,192.168.0.11,192.168.0.12,192.168.0.13,192.168.0.14",
							args[2], sb.toString(), args[1] + i };
					System.out.println("i>>" + i);
					System.out.println("路径:>>" + sb.toString());
					ToolRunner.run(new FinancialLogisticsHDFS2ESV1Job(), args1);

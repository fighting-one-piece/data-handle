...
public class SocialSecurityES2HDFSJob extends BaseES2HDFSJob {
	...
	public static void main(String[] args) {
		...
		try {
			...
			args = new String[]{"192.168.0.20", "account/account",
					"hdfs://192.168.0.10:9000/elasticsearch_original/account/account/20","1800000"};
			int exitCode = ToolRunner.run(new SocialSecurityES2HDFSJob(), args); 

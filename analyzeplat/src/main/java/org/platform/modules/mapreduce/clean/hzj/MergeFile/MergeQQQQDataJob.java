 ...
 * @author 
 */
public class MergeQQQQDataJob {

	static FileSystem fs = null;
	static Configuration conf = new Configuration();
	static String regex = "^(correct)+.*$";
	// 输入/输出文件路径
	static String pathIn = "hdfs://192.168.0.10:9000/warehouse_clean/qq/qqdata/20170103";
	static String pathOut = "hdfs://192.168.0.10:9000/warehouse_clean/qq/qqdata/20170103/combine";
	...
	public static void main(String[] args) throws Exception {
		...
		// 创建job对象
		Job job = Job.getInstance(conf, "MergeQQQQDataJob");
		// 设置运行的类
		job.setJarByClass(MergeQQQQDataJob.class);
		// 设置mapper类

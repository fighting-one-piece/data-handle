...
public class MoveHdfsFile {
	...
	public static void main(String[] args){
		String src = "hdfs://192.168.0.10:9000/warehouse_data/work/cybercafe";
		String dst = "hdfs://192.168.0.10:9000/warehouse_data/work/cybercafe";
		/**
		 *  src	需要移动的文件或目录
		 * dst	移动的目标目录
		 * param		指定移动文件类型（eg:account   email）
		 */
		MoveFileAndReName(src,dst,"cybercafe");
	}
...
//						if (name.matches(regex1)|| name.matches(regex2)||name.matches(regex3))
						if (name.matches(reg))
						{

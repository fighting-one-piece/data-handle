 ...
 *
 */
public class WorkHospitalHDFS2HDFSV1Job extends BaseHDFS2HDFSJob {
	...
	public static void main(String[] args) {
		try {
			...
			for (int i = 0; i <= 9; i++) {
				...
				exitCode = ToolRunner.run(new WorkHospitalHDFS2HDFSV1Job(), args);
			}
...
class HospitalHDFS2HDFSMapper extends BaseHDFS2HDFSV1Mapper {

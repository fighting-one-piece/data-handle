...
public class QQQunRelationHDFS2ESV2Job  extends BaseHDFS2ESV2Job{
	public static void main(String[] args) {
		try {
			args = new String[] {"hdfs://192.168.0.10:9000/warehouse_clean/qq/qqqunrelation/20161220/"};
			...
			for (int i = 0,len = files.size();i<len; i++) {
				...
				if ((i % 5 == 0 || i == (len - 1)) && i != 0) {
					...
					String[] args1 = new String[] { "qq", "qqqunrelation", "cisiondata",
							"192.168.0.10,192.168.0.12","5000",sb.toString()};
					ToolRunner.run(new QQQunRelationHDFS2ESV2Job(), args1);

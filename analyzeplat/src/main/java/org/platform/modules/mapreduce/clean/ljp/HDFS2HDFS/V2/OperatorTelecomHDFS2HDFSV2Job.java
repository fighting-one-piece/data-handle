 ...
 *
 */
public class OperatorTelecomHDFS2HDFSV2Job extends BaseHDFS2HDFSJob {
	...
	public static void main(String[] args) {
		try {
			...
			for (int i = 0; i <= 9; i++) {
				...
				exitCode = ToolRunner.run(new OperatorTelecomHDFS2HDFSV2Job(), args);
			}
		 }
...
class TelecomHDFS2HDFSMapper extends BaseHDFS2HDFSV2Mapper {

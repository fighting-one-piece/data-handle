 ...
 *
 */
public class FinancialBusinessHDFS2ESJob extends BaseHDFS2ESV2Job {
		...
		try {
			...
			for (int i = 0, len = files.size(); i < len; i++) {
				...
				if ((i % 5 == 0 || i == (len - 1)) && i != 0) {
					...
					String[] args1 = new String[] { "financial_new", "business", "cisiondata", "192.168.0.10,192.168.0.12",
							"1000",sb.toString() };
					
					ToolRunner.run(new FinancialBusinessHDFS2ESJob(), args1);

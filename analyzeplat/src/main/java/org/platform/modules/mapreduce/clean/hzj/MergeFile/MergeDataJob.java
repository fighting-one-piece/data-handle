 ...
 * @author 
 */
public class MergeDataJob {

	static FileSystem fs = null;
	static Configuration conf = new Configuration();
	static String regex = "^(0000)+.*$";
	// 输入/输出文件路径
	static String pathIn = "hdfs://192.168.0.10:9000/user/hzj/account";
	static String pathOut = "hdfs://192.168.0.10:9000/user/hzj/accountCCC/";
	...
	public static void main(String[] args) throws Exception {
		...
		// 创建job对象
		Job job = Job.getInstance(conf, "MergeDataJob");
		// 设置运行的类
		job.setJarByClass(MergeDataJob.class);
		// 设置mapper类

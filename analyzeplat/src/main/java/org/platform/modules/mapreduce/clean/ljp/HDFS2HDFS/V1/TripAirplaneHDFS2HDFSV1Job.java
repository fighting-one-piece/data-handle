 ...
 *
 */
public class TripAirplaneHDFS2HDFSV1Job extends BaseHDFS2HDFSJob {
	...
	public static void main(String[] args) {
		try {
			...
			for (int i = 0; i <= 19; i++) {
				...
				exitCode = ToolRunner.run(new TripAirplaneHDFS2HDFSV1Job(), args);
			}
...
class AirplaneHDFS2HDFSMapper extends BaseHDFS2HDFSV1Mapper {

 ...
 *
 */
public class TripAirplaneES2HDFSJob2 extends BaseES2HDFSJob{
	...
	public static void main(String[] args) {
		...
		try {
			...
			args = new String[]{"192.168.0.10","trip/airplane","hdfs://192.168.0.10:9000/elasticsearch_original/trip/airplane/10/","1500000"};
			int exitCode = ToolRunner.run(new TripAirplaneES2HDFSJob2(), args);  

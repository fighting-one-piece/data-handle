...
public class PostgreSQLCopyExportJob extends JdbcExportJob {
	...
	public PostgreSQLCopyExportJob(final ExportJobContext ctxt, final Class<? extends Mapper> mapperClass,
	...
	protected void propagateOptionsToJob(Job job) {
		...
		setDelimiter("postgresql.input.field.delim", opts.getInputFieldDelim(), conf);
		setDelimiter("postgresql.input.record.delim", opts.getInputRecordDelim(), conf);
		setDelimiter("postgresql.input.enclosedby", opts.getInputEnclosedBy(), conf);
	...
	private void setDelimiter(String prop, String val, Configuration conf) {
		conf.set(prop, val);
	}

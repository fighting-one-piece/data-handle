...
public class MySQLDumpImportJob extends ImportJobBase {
	...
	public MySQLDumpImportJob(final SqoopOptions opts, ImportJobContext context) throws ClassNotFoundException {
	...
	protected void configureInputFormat(Job job, String tableName, String tableClassName, String splitByCol)
		 ...
		 */
		conf.set(MySQLUtils.OUTPUT_FIELD_DELIM_KEY, options.getOutputFieldDelim());

...
public class NetezzaExternalTableExportJob extends ExportJobBase {
	...
	protected void propagateOptionsToJob(Job job) {
		 ...
		 */
		conf.set(DelimiterSet.INPUT_FIELD_DELIM_KEY, options.getInputFieldDelim());
		conf.setInt(DelimiterSet.INPUT_RECORD_DELIM_KEY, options.getInputRecordDelim());
		conf.setInt(DelimiterSet.INPUT_ENCLOSED_BY_KEY, options.getInputEnclosedBy());
		...
		conf.setBoolean(DelimiterSet.INPUT_ENCLOSE_REQUIRED_KEY, options.isOutputEncloseRequired());
	}
	...
	@Override
	protected void configureInputFormat(Job job, String tableName, String tableClassName, String splitCol)
